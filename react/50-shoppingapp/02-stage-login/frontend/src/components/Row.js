	...
	render() {
		return (
			<Table.Row>
				...
				onClick={() => this.props.changeToRemoveState(this.props.item.id)}>Remove</Button></Table.Cell>
				<Table.Cell><Button color="green" 
				onClick={() => this.props.changeToEditState(this.props.item.id)}>Edit</Button></Table.Cell>
			</Table.Row>
		)
	}
}